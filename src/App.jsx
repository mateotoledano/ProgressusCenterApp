...
function App() {
  ...
  return (
    <LayoutLoginRegister>
      <div className={`animate-fade-in-down w-full min-h-screen  items-center  justify-center p-4 bg-customGray md:flex  md:flex-col md:items-start ${selectedAuth === "login" ?  "md:justify-center" :"md:justify-start"}  `}>
